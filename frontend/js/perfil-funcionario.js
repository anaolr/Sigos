document.addEventListener("DOMContentLoaded", () => {
  ...
  // ==========================================
  // BUSCAR OS DADOS REAIS NO BACKEND
  // ==========================================
  async function carregarPerfil() {
      try {
          ...
          if (response.ok) {
              ...
              console.error("Erro ao carregar dados do perfil do banco.");
          }
      } catch (erro) {
 ...
 function preencherFormulario(dados) {
    ...
    if(campos.tipoUsuario) campos.tipoUsuario.value = "Funcionário";
  ...
  if(campos.nome) campos.nome.addEventListener("input", () => {
  ...
  // Agora inicia a página chamando a função que fala com o Banco de Dados
  carregarPerfil();
});